...
import { DeviceDrawer, DeviceLine, NavigationButtons, Spacer } from "../../../../components";
import { useNavigate, useRootSelector } from "../../../../utils";
import { useStyles } from "../../utils";
import { ExpenseItemList } from "../../components/ExpenseItemList";
import { Device } from "../../../../types";
import { getDevice, getDeviceIdList, getDeviceName, getLastSelectedOrFirstDeviceId, actions as allActions } from "../../../../store";
    ...
    return (
        <Box className={classes.root}>
            {device === undefined ? (
                ...
                <>
                    <DeviceLine onClick={() => setIsDrawerOpened(true)} spz={device.spz} isExpanded={isDrawerOpened} imageUrl={device.imageUrl} {...{ name }} />
            ...
            <NavigationButtons previousText={strings.cancel} nextText={strings.complete} onPreviousClick={goBack} />
            <DeviceDrawer
