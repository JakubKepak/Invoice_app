...
import { NewDeviceErrorDataState, TransmissionType } from "../../types";
...
type State = {
    ...
    errorData: NewDeviceErrorDataState,
...
export const newDeviceSlice = createSlice({
    ...
    reducers: {
        ...
        setFirstRegistrationDate: (state, action: PayloadAction<Date | undefined>) => {
...
export const actions = newDeviceSlice.actions;
